...
<head>
    <title>Pirripneus | Prodotto</title>
            ...
            <div id="collegamenti">
                ...
                <?php
                    ...
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=paginaprodotto.php?type=".$_GET['type']."%26code=".$_GET['code']."\"class=\"button\"> Accedi</a>");
                    }
                ?>
            </div>
            <div id="hamburger">
            ...
            <div id="hamburgermenu" class = "hidden">
                ...
                <?php
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=paginaprodotto.php?type=".$_GET['type']."%26code=".$_GET['code']."\" class=\"hamburgeritem\"> Accedi</a>");
                    }
                ?>
            <div>
        </nav>
