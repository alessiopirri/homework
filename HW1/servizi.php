...
<head>
    <title>Pirripneus | Servizi</title>
    ...
    <script src="scripts/servizi.js"></script>
            ...
            <div id="collegamenti">
                ...
                <?php
                    ...
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=servizi.php\" class=\"button\"> Accedi</a>");
                    }
                ?>
            </div>
            <div id="hamburger">
            ...
            <div id="hamburgermenu" class = "hidden">
                ...
                <?php
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=servizi.php\" class=\"hamburgeritem\"> Accedi</a>");
                    }
                ?>
            <div>
        </nav>
