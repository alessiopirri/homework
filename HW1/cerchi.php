...
<head>
    <title>Pirripneus | Cerchi</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="UTF-8">
    <link rel="stylesheet" href="style/common.css">
    <link rel="stylesheet" href="style/cerchi.css">
            ...
            <div id="collegamenti">
                ...
                <?php
                    ...
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=cerchi.php\" class=\"button\"> Accedi</a>");
                    }
                ?>
            </div>
            <div id="hamburger">
            ...
            <div id="hamburgermenu" class = "hidden">
                ...
                <?php
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=cerchi.php\" class=\"hamburgeritem\"> Accedi</a>");
                    }
                ?>
            <div>
        </nav>
