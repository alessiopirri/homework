<?php
    ...
    if(!checkAuth()){
        header("Location: login.php?ritorno=profilo.php");
    }
?>
...
<head>
    <title>Pirripneus | Profilo</title>
            ...
            <div id="collegamenti">
                ...
                <?php
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=profilo.php\" class=\"button\"> Accedi</a>");
                    }
                ?>
            </div>
            <div id="hamburger">
            ...
            <div id="hamburgermenu" class = "hidden">
                ...
                <?php
                    if(isset($_SESSION["email"])){
                        ...
                        echo ("<a href=\"login.php?ritorno=profilo.php\" class=\"hamburgeritem\"> Accedi</a>");
                    }
                ?>
            <div>
        </nav>
